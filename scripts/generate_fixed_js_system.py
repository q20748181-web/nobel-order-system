"""
修复JavaScript转义问题的系统HTML
"""
import os

def generate_fixed_js_system_html():
    """生成修复转义问题的HTML代码"""
...
if __name__ == "__main__":
    html_content = generate_fixed_js_system_html()
    
    # 保存到文件
    output_file = "/workspace/projects/assets/cabinet_system_v6_fixed.html"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ 修复JavaScript转义问题的系统HTML文件已生成：", output_file)
