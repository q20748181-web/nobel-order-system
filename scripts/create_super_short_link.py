...
if __name__ == "__main__":
    ...
    if url:
        ...
        print(url)
        print(f"\n📝 长度对比：")
        print(f"  原始链接: {len('https://coze-coding-project.tos.coze.site/coze_storage_7611717619640762422/cabinet_enhanced_final_de484c72.html?sign=1774844498-1cf0449c68-0-566bc097e3a6d1fc93bcca4e364ba6c753f65bdf40dbe6683f0d87570f234b26')} 字符")
        print(f"  短链接: {len(url)} 字符")
        print(f"  缩短了: {len('https://coze-coding-project.tos.coze.site/coze_storage_7611717619640762422/cabinet_enhanced_final_de484c72.html?sign=1774844498-1cf0449c68-0-566bc097e3a6d1fc93bcca4e364ba6c753f65bdf40dbe6683f0d87570f234b26') - len(url)} 字符")
        print(f"\n📝 说明：")
        print("- 此链接会自动跳转到橱柜订单管理系统")
        print("- 如果自动跳转失败，点击页面上的按钮即可")
        print("- 有效期：1年")
        print("- 文件名：c.html（超短命名）")
        print("\n" + "=" * 80)
    else:
        print("\n❌ 创建失败，请使用原始链接")
