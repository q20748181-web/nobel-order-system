...
def generate_with_edit_system_html():
    """生成包含编辑功能的HTML代码"""
...
<body>
    ...
    <script>
        ...
        function initDemoData() {
            ...
            orders = [
                { id: 1, orderNo: "SAM202401010001", type: "sample", customerId: 1, status: "pending", content: "客厅柜子打样", amount: 0, notes: "", createdAt: "2024-01-01T00:00:00.000Z" },
                { id: 2, orderNo: "DSN202401020001", type: "design", customerId: 2, status: "processing", content: "厨房整体设计", amount: 35000, notes: "设计稿已确认", createdAt: "2024-01-02T00:00:00.000Z" },
                { id: 3, orderNo: "ORD202401030001", type: "formal", customerId: 3, status: "completed", content: "全套橱柜定制", amount: 85000, notes: "等待确认", createdAt: "2024-01-03T00:00:00.000Z" },
        ...
        function showEditOrderForm(id, type) {
            ...
            html += '<div class="form-group"><label>订单号</label><input type="text" id="orderNo" value="' + order.orderNo + '" disabled style="background: #f5f5f5;"></div>';
            ...
            html += '<div class="form-group"><label>金额（元）</label><input type="number" id="orderAmount" min="0" step="100" value="' + order.amount + '"></div>';
...
if __name__ == "__main__":
    html_content = generate_with_edit_system_html()
    
    # 保存到文件
    output_file = "/workspace/projects/assets/cabinet_system_v5_with_edit.html"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ 带编辑功能的系统HTML文件已生成：", output_file)
