"""
增强版订单系统HTML（包含执行人员功能）
"""
import os

def generate_order_system_with_executor_html():
    """生成包含执行人员功能的订单HTML代码"""
...
if __name__ == "__main__":
    html_content = generate_order_system_with_executor_html()
    
    output_file = "/workspace/projects/assets/cabinet_system_v8_with_executor.html"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ 包含执行人员功能的订单系统HTML文件已生成：", output_file)
