...
<body>
    ...
    # 保存到assets目录
    output_path = os.path.join(os.getenv("COZE_WORKSPACE_PATH", "/workspace/projects"), "assets", "cabinet_system_v14.html")
