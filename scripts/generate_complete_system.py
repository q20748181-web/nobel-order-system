"""
重新生成完整功能的橱柜订单管理系统HTML
"""
import os

def generate_complete_system_html():
    """生成完整功能的HTML代码"""
...
<body>
    ...
    <script>
        ...
        function loadData() {
            try {
                customers = JSON.parse(localStorage.getItem('cabinet_customers_v2')) || [];
                orders = JSON.parse(localStorage.getItem('cabinet_orders_v2')) || [];
            } catch(e) {
                customers = [];
                orders = [];
            }
...
if __name__ == "__main__":
    html_content = generate_complete_system_html()
    
    # 保存到文件
    output_file = "/workspace/projects/assets/cabinet_system_v2_complete.html"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ 完整版系统HTML文件已生成：", output_file)
