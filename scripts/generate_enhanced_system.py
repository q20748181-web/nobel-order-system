"""
添加可点击仪表盘和订单状态归类的系统HTML
"""
import os

def generate_enhanced_system_html():
    """生成增强版HTML代码"""
...
if __name__ == "__main__":
    html_content = generate_enhanced_system_html()
    
    # 保存到文件
    output_file = "/workspace/projects/assets/cabinet_system_v4_enhanced.html"
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("✅ 增强版系统HTML文件已生成：", output_file)
